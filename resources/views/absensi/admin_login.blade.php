...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .orb-3 { width: 180px; height: 180px; background: #06b6d4; top: 50%; left: 50%; transform: translate(-50%,-50%); animation-delay: -2s; }
        @keyframes orbFloat {
            from { transform: translate(0, 0); }
            to   { transform: translate(20px, 25px); }
        }
        /* Fix orb-3 float since it uses transform for centering */
        .orb-3 { animation: orb3Float 10s ease-in-out infinite alternate; }
        @keyframes orb3Float {
            from { top: 48%; left: 48%; }
            to   { top: 52%; left: 52%; }
        }
        ...
        .login-input::placeholder { color: #475569; letter-spacing: 0.02em; }
        .toggle-pw {
            position: absolute;
            right: 0.9rem;
            top: 50%;
    ...
    <div class="right-panel">
        <div class="login-box">
            ...
            <div class="login-greeting">
                ...
                <p class="login-subtitle">Masukkan password admin untuk mengakses dashboard.</p>
            </div>
